...
# start = time.time()
# registrar = registration.Valis(slide_src_dir, registered_slide_dst_dir)
# rigid_registrar, non_rigid_registrar, error_df = registrar.register()
# stop = time.time()
# elapsed = stop - start
# print("registration time is "+str(elapsed/60)+" minutes")

# he wsiType=0 first_thresh_val=253.5 sencond_thresh_val=249.5 low_thresh_val=200
# ihc wsiType=1 first_thresh_val=254.5 sencond_thresh_val=250.5 low_thresh_val=200
...
#     elif (wsiType == 1):
#         first_thresh_val = 253.5
#         second_thresh_val = 249.0
#     else:
...
#     num_w = wsi_width // scan_step
#     num_h = wsi_high // scan_step
#     print(num_w, num_h)
#
#     for i in range(num_w - 1):
#         flag = False
#         for j in range(num_h):
#             checkimg = np.array(tif_slide.read_region((scan_step * i, scan_step * j), 0, (scan_step, scan_step)))
#             checkmean = np.mean(np.array(checkimg))
#             print(checkmean)
#
#             if (checkmean < first_thresh_val and checkmean > low_thresh_val):
#                 nextCheckimg = np.array(
#                     tif_slide.read_region((scan_step * (i + 1), scan_step * j), 0, (scan_step, scan_step)))
#                 if (np.mean(np.array(nextCheckimg)) < second_thresh_val):
#                     print(np.mean(np.array(nextCheckimg)))
#                     flag = True
#                     break
#         if (flag):
#             left_boundery = i * scan_step
#             break
#
...
#         for j in range(num_h):
#             checkimg = np.array(
#                 tif_slide.read_region((wsi_width - scan_step * (i + 1), scan_step * j), 0, (scan_step, scan_step)))
#             checkmean = np.mean(np.array(checkimg))
#             print(checkmean)
#
#             if (checkmean < first_thresh_val and checkmean > low_thresh_val):
#                 nextCheckimg = np.array(
#                     tif_slide.read_region((wsi_width - scan_step * (i + 2), scan_step * j), 0, (scan_step, scan_step)))
#                 if (np.mean(np.array(nextCheckimg)) < second_thresh_val):
#                     print(np.mean(np.array(nextCheckimg)))
#                     flag = True
#                     break
#         if (flag):
#             right_boundery = wsi_width - i * scan_step
#             break
#
...
#             checkimg = np.array(
#                 tif_slide.read_region((left_boundery + scan_step * j, scan_step * i), 0, (scan_step, scan_step)))
#             checkmean = np.mean(np.array(checkimg))
#             # print(checkmean)
#
#             if (checkmean < first_thresh_val and checkmean > low_thresh_val):
#                 nextCheckimg = np.array(
#                     tif_slide.read_region((left_boundery + scan_step * j, scan_step * (i + 1)), 0,
#                                           (scan_step, scan_step)))
#                 if (np.mean(np.array(nextCheckimg)) < second_thresh_val):
#                     print(np.mean(np.array(nextCheckimg)))
#                     flag = True
...
#         for j in range(0, (right_boundery - left_boundery) // scan_step):
#             checkimg = np.array(
#                 tif_slide.read_region((left_boundery + scan_step * j, wsi_high - scan_step * (i + 1)), 0,
#                                       (scan_step, scan_step)))
#             checkmean = np.mean(np.array(checkimg))
#             # print(checkmean)
#
#             if (checkmean < first_thresh_val and checkmean > low_thresh_val):
#                 nextCheckimg = np.array(
#                     tif_slide.read_region((left_boundery + scan_step * j, wsi_high - scan_step * (i + 2)), 0,
#                                           (scan_step, scan_step)))
#                 if (np.mean(np.array(nextCheckimg)) < second_thresh_val):
#                     print(np.mean(np.array(nextCheckimg)))
#                     flag = True
#                     break
#         if (flag):
#             down_boundery = wsi_high - i * scan_step
#             break
#
